...
object Collaborator {
  ...
  case class Create(appId: String, email: String) extends RequestWithBody[CollaboratorBody, Collaborator] {
  ...
  case class List(appId: String, range: Option[String] = None) extends ListRequest[Collaborator] {
    val endpoint: String = s"/apps/$appId/collaborators"
  ...
  case class Info(appId: String, collaboratorId: String) extends Request[Collaborator] {
    val expect: Set[Int] = expect200
    val endpoint: String = s"/apps/$appId/collaborators/$collaboratorId"
    val method: String = GET
  }

  case class Delete(appId: String, collaboratorId: String) extends Request[Collaborator] {
    val expect: Set[Int] = expect200
    val endpoint: String = s"/apps/$appId/collaborators/$collaboratorId"
