...
object Addon {
  ...
  case class Update(appIdOrName: String, addonIdOrName: String, plan: String, config: Map[String, String] = Map.empty, extraHeaders: Map[String, String] = Map.empty) extends RequestWithBody[AddonChange, Addon] {
    val expect: Set[Int] = expect200
    val endpoint: String = s"/apps/$appIdOrName/addons/$addonIdOrName"
  ...
  case class Delete(appIdOrName: String, addonIdOrName: String, extraHeaders: Map[String, String] = Map.empty) extends Request[Addon] {
    val expect: Set[Int] = expect200
    val endpoint: String = s"/apps/$appIdOrName/addons/$addonIdOrName"
