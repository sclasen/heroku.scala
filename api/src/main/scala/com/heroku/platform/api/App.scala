...
object HerokuApp {
  ...
  case class Create(name: Option[String] = None, stack: Option[String] = Some("cedar"), region: Option[AppRegion] = None) extends RequestWithBody[CreateAppBody, HerokuApp] {
    val endpoint = "/apps"
  ...
  case class Info(id: String) extends Request[HerokuApp] {
    val endpoint = s"/apps/$id"
    val expect = expect200
    val method = GET
  }

  case class Update(id: String, maintenance: Option[Boolean] = None, name: Option[String] = None, owner: Option[AppOwner] = None) extends RequestWithBody[UpdateAppBody, HerokuApp] {
    val endpoint = s"/apps/$id"
    val expect = expect200
    val method = PATCH
  ...
  case class Delete(id: String) extends Request[HerokuApp] {
    val endpoint = s"/apps/$id"
    val expect = expect200
    val method = DELETE
  }
