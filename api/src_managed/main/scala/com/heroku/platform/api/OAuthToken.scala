...
object OAuthToken {
  ...
  object models {
    case class CreateOAuthTokenBody(client: Option[OAuthTokenClient] = None, grant: OAuthTokenGrant, refresh_token: Option[OAuthTokenRefreshToken] = None)
  ...
  case class Create(client: Option[OAuthTokenClient] = None, grant: OAuthTokenGrant, refresh_token: Option[OAuthTokenRefreshToken] = None) extends RequestWithBody[models.CreateOAuthTokenBody, OAuthToken] {
...
case class OAuthTokenIdentity(id: Option[String])

case object OAuthTokenIdentity {
  def byId(id: String) = OAuthTokenIdentity(Some(id))
}
...
trait OAuthTokenRequestJson {
  ...
  implicit def ToJsonOAuthTokenIdentity: ToJson[OAuthTokenIdentity]
}
