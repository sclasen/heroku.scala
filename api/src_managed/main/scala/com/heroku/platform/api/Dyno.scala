...
object Dyno {
  ...
  object models {
    case class CreateDynoBody(attach: Option[Boolean] = None, command: String, env: Option[Map[String, String]] = None, size: Option[Int] = None)
    case class DynoRelease(id: String, version: Int)
  }
  case class Create(app_id_or_name: String, attach: Option[Boolean] = None, command: String, env: Option[Map[String, String]] = None, size: Option[Int] = None) extends RequestWithBody[models.CreateDynoBody, Dyno] {
...
case class Dyno(name: String, size: Int, state: String, attach_url: Option[String], command: String, id: String, created_at: String, release: models.DynoRelease, `type`: String, updated_at: String)

case class DynoIdentity(id: Option[String], name: Option[String])

case object DynoIdentity {
  def byId(id: String) = DynoIdentity(Some(id), None)
  def byName(name: String) = DynoIdentity(None, Some(name))
}
...
trait DynoRequestJson {
  ...
  implicit def ToJsonDynoIdentity: ToJson[DynoIdentity]
}
