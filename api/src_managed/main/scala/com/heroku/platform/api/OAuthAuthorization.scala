...
object OAuthAuthorization {
  ...
  object models {
    case class CreateOAuthAuthorizationBody(client: Option[String] = None, description: Option[String] = None, scope: Array[String])
  ...
  case class Create(client_id: Option[String] = None, description: Option[String] = None, scope: Array[String]) extends RequestWithBody[models.CreateOAuthAuthorizationBody, OAuthAuthorization] {
    val expect: Set[Int] = expect201
    val endpoint: String = "/oauth/authorizations"
    val method: String = POST
    val body: models.CreateOAuthAuthorizationBody = models.CreateOAuthAuthorizationBody(client_id, description, scope)
  }
...
case class OAuthAuthorization(access_token: Option[models.OAuthAuthorizationAccessToken], refresh_token: Option[models.OAuthAuthorizationRefreshToken], id: String, client: Option[models.OAuthAuthorizationClient], grant: Option[models.OAuthAuthorizationGrant], created_at: String, updated_at: String)
