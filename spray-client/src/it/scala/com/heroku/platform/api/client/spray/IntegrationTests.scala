...
class SprayAccountFeatureSpec extends AccountFeatureSpec(SprayJsonBoilerplate) with SprayApiSpec
...
class SprayAppFeatureSpec extends AppSpec(SprayJsonBoilerplate) with SprayApiSpec
