...
object SprayJsonIgnoreNullBoilerplate extends DefaultJsonProtocol with ApiRequestJson {
  ...
  implicit lazy val FormatAccountIdentity: JsonFormat[AccountIdentity] = jsonFormat2(AccountIdentity.apply)
  ...
  implicit lazy val FormatAccountFeatureIdentity: JsonFormat[AccountFeatureIdentity] = jsonFormat2(AccountFeatureIdentity.apply)
  implicit lazy val FormatAddonServiceIdentity: JsonFormat[AddonServiceIdentity] = jsonFormat2(AddonServiceIdentity.apply)
  ...
  implicit lazy val FormatAppFeatureIdentity: JsonFormat[AppFeatureIdentity] = jsonFormat2(AppFeatureIdentity.apply)
  ...
  implicit lazy val FormatAppTransferIdentity: JsonFormat[AppTransferIdentity] = jsonFormat1(AppTransferIdentity.apply)
  ...
  implicit lazy val FormatCollaboratorIdentity: JsonFormat[CollaboratorIdentity] = jsonFormat2(CollaboratorIdentity.apply)
  implicit lazy val FormatDomainIdentity: JsonFormat[DomainIdentity] = jsonFormat2(DomainIdentity.apply)
  ...
  implicit lazy val FormatDynoIdentity: JsonFormat[DynoIdentity] = jsonFormat2(DynoIdentity.apply)
  ...
  implicit lazy val FormatFormationIdentity: JsonFormat[FormationIdentity] = jsonFormat2(FormationIdentity.apply)
  ...
  implicit lazy val FormatHerokuAppIdentity: JsonFormat[HerokuAppIdentity] = jsonFormat2(HerokuAppIdentity.apply)
  ...
  implicit lazy val FormatKeyIdentity: JsonFormat[KeyIdentity] = jsonFormat2(KeyIdentity.apply)
  ...
  implicit lazy val FormatLogSessionIdentity: JsonFormat[LogSessionIdentity] = jsonFormat1(LogSessionIdentity.apply)
  implicit lazy val FormatOAuthAuthorizationmodelsCreateOAuthAuthorizationBody: JsonFormat[OAuthAuthorization.models.CreateOAuthAuthorizationBody] = jsonFormat3(OAuthAuthorization.models.CreateOAuthAuthorizationBody.apply)
  ...
  implicit lazy val FormatOAuthAuthorizationIdentity: JsonFormat[OAuthAuthorizationIdentity] = jsonFormat1(OAuthAuthorizationIdentity.apply)
  ...
  implicit lazy val FormatOAuthClientIdentity: JsonFormat[OAuthClientIdentity] = jsonFormat1(OAuthClientIdentity.apply)
  ...
  implicit lazy val FormatOAuthTokenIdentity: JsonFormat[OAuthTokenIdentity] = jsonFormat1(OAuthTokenIdentity.apply)
  implicit lazy val FormatPlanmodelsPlanPrice: JsonFormat[Plan.models.PlanPrice] = jsonFormat2(Plan.models.PlanPrice.apply)
  implicit lazy val FormatPlanIdentity: JsonFormat[PlanIdentity] = jsonFormat2(PlanIdentity.apply)
  implicit lazy val FormatRegionIdentity: JsonFormat[RegionIdentity] = jsonFormat2(RegionIdentity.apply)
  ...
  implicit lazy val FormatReleaseIdentity: JsonFormat[ReleaseIdentity] = jsonFormat2(ReleaseIdentity.apply)
  ...
  implicit lazy val FormatSslEndpointIdentity: JsonFormat[SslEndpointIdentity] = jsonFormat2(SslEndpointIdentity.apply)
  implicit lazy val FormatStackIdentity: JsonFormat[StackIdentity] = jsonFormat2(StackIdentity.apply)
  ...
  implicit lazy val ToJsonAccountIdentity: ToJson[AccountIdentity] = to[AccountIdentity]
  ...
  implicit lazy val ToJsonAccountFeatureIdentity: ToJson[AccountFeatureIdentity] = to[AccountFeatureIdentity]
  implicit lazy val ToJsonAddonServiceIdentity: ToJson[AddonServiceIdentity] = to[AddonServiceIdentity]
  ...
  implicit lazy val ToJsonAppFeatureIdentity: ToJson[AppFeatureIdentity] = to[AppFeatureIdentity]
  ...
  implicit lazy val ToJsonAppTransferIdentity: ToJson[AppTransferIdentity] = to[AppTransferIdentity]
  ...
  implicit lazy val ToJsonCollaboratorIdentity: ToJson[CollaboratorIdentity] = to[CollaboratorIdentity]
  implicit lazy val ToJsonDomainIdentity: ToJson[DomainIdentity] = to[DomainIdentity]
  ...
  implicit lazy val ToJsonDynoIdentity: ToJson[DynoIdentity] = to[DynoIdentity]
  ...
  implicit lazy val ToJsonFormationIdentity: ToJson[FormationIdentity] = to[FormationIdentity]
  ...
  implicit lazy val ToJsonHerokuAppIdentity: ToJson[HerokuAppIdentity] = to[HerokuAppIdentity]
  implicit lazy val ToJsonCreateKeyBody: ToJson[Key.models.CreateKeyBody] = to[Key.models.CreateKeyBody]
  implicit lazy val ToJsonKeyIdentity: ToJson[KeyIdentity] = to[KeyIdentity]
  ...
  implicit lazy val ToJsonLogSessionIdentity: ToJson[LogSessionIdentity] = to[LogSessionIdentity]
  ...
  implicit lazy val ToJsonOAuthAuthorizationIdentity: ToJson[OAuthAuthorizationIdentity] = to[OAuthAuthorizationIdentity]
  ...
  implicit lazy val ToJsonOAuthClientIdentity: ToJson[OAuthClientIdentity] = to[OAuthClientIdentity]
  ...
  implicit lazy val ToJsonOAuthTokenIdentity: ToJson[OAuthTokenIdentity] = to[OAuthTokenIdentity]
  implicit lazy val ToJsonPlanPrice: ToJson[Plan.models.PlanPrice] = to[Plan.models.PlanPrice]
  implicit lazy val ToJsonPlanIdentity: ToJson[PlanIdentity] = to[PlanIdentity]
  implicit lazy val ToJsonRegionIdentity: ToJson[RegionIdentity] = to[RegionIdentity]
  ...
  implicit lazy val ToJsonReleaseIdentity: ToJson[ReleaseIdentity] = to[ReleaseIdentity]
  ...
  implicit lazy val ToJsonSslEndpointIdentity: ToJson[SslEndpointIdentity] = to[SslEndpointIdentity]
  implicit lazy val ToJsonStackIdentity: ToJson[StackIdentity] = to[StackIdentity]
...
object SprayJsonBoilerplate extends DefaultJsonProtocol with NullOptions with ApiRequestJson with ApiResponseJson {
  ...
  implicit lazy val FormatOAuthAuthorizationmodelsOAuthAuthorizationClient: JsonFormat[OAuthAuthorization.models.OAuthAuthorizationClient] = jsonFormat3(OAuthAuthorization.models.OAuthAuthorizationClient.apply)
  implicit lazy val FormatOAuthAuthorizationmodelsOAuthAuthorizationGrant: JsonFormat[OAuthAuthorization.models.OAuthAuthorizationGrant] = jsonFormat3(OAuthAuthorization.models.OAuthAuthorizationGrant.apply)
  implicit lazy val FormatOAuthAuthorization: JsonFormat[OAuthAuthorization] = jsonFormat7(OAuthAuthorization.apply)
  ...
  implicit lazy val FormatSslEndpoint: JsonFormat[SslEndpoint] = jsonFormat8(SslEndpoint.apply)
  ...
  implicit lazy val ToJsonAccountIdentity: ToJson[AccountIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonAccountIdentity
  ...
  implicit lazy val ToJsonAccountFeatureIdentity: ToJson[AccountFeatureIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonAccountFeatureIdentity
  implicit lazy val ToJsonAddonServiceIdentity: ToJson[AddonServiceIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonAddonServiceIdentity
  ...
  implicit lazy val ToJsonAppFeatureIdentity: ToJson[AppFeatureIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonAppFeatureIdentity
  ...
  implicit lazy val ToJsonAppTransferIdentity: ToJson[AppTransferIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonAppTransferIdentity
  ...
  implicit lazy val ToJsonCollaboratorIdentity: ToJson[CollaboratorIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonCollaboratorIdentity
  implicit lazy val ToJsonDomainIdentity: ToJson[DomainIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonDomainIdentity
  ...
  implicit lazy val ToJsonDynoIdentity: ToJson[DynoIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonDynoIdentity
  ...
  implicit lazy val ToJsonFormationIdentity: ToJson[FormationIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonFormationIdentity
  ...
  implicit lazy val ToJsonHerokuAppIdentity: ToJson[HerokuAppIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonHerokuAppIdentity
  implicit lazy val ToJsonCreateKeyBody: ToJson[Key.models.CreateKeyBody] = SprayJsonIgnoreNullBoilerplate.ToJsonCreateKeyBody
  implicit lazy val ToJsonKeyIdentity: ToJson[KeyIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonKeyIdentity
  ...
  implicit lazy val ToJsonLogSessionIdentity: ToJson[LogSessionIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonLogSessionIdentity
  ...
  implicit lazy val ToJsonOAuthAuthorizationIdentity: ToJson[OAuthAuthorizationIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonOAuthAuthorizationIdentity
  ...
  implicit lazy val ToJsonOAuthClientIdentity: ToJson[OAuthClientIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonOAuthClientIdentity
  ...
  implicit lazy val ToJsonOAuthTokenIdentity: ToJson[OAuthTokenIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonOAuthTokenIdentity
  implicit lazy val ToJsonPlanPrice: ToJson[Plan.models.PlanPrice] = SprayJsonIgnoreNullBoilerplate.ToJsonPlanPrice
  implicit lazy val ToJsonPlanIdentity: ToJson[PlanIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonPlanIdentity
  implicit lazy val ToJsonRegionIdentity: ToJson[RegionIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonRegionIdentity
  ...
  implicit lazy val ToJsonReleaseIdentity: ToJson[ReleaseIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonReleaseIdentity
  ...
  implicit lazy val ToJsonSslEndpointIdentity: ToJson[SslEndpointIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonSslEndpointIdentity
  implicit lazy val ToJsonStackIdentity: ToJson[StackIdentity] = SprayJsonIgnoreNullBoilerplate.ToJsonStackIdentity
