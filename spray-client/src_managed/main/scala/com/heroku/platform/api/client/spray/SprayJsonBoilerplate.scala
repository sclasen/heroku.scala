...
object SprayJsonIgnoreNullBoilerplate extends DefaultJsonProtocol with ApiRequestJson {
  ...
  implicit lazy val FormatFormationmodelsMultiUpdateFormationBody: JsonFormat[Formation.models.MultiUpdateFormationBody] = jsonFormat1(Formation.models.MultiUpdateFormationBody.apply)
  implicit lazy val FormatFormationmodelsUpdate: JsonFormat[Formation.models.Update] = jsonFormat3(Formation.models.Update.apply)
  ...
  implicit lazy val ToJsonMultiUpdateFormationBody: ToJson[Formation.models.MultiUpdateFormationBody] = to[Formation.models.MultiUpdateFormationBody]
  implicit lazy val ToJsonUpdateFormation: ToJson[Formation.models.Update] = to[Formation.models.Update]
...
object SprayJsonBoilerplate extends DefaultJsonProtocol with NullOptions with ApiRequestJson with ApiResponseJson {
  ...
  implicit lazy val ToJsonMultiUpdateFormationBody: ToJson[Formation.models.MultiUpdateFormationBody] = SprayJsonIgnoreNullBoilerplate.ToJsonMultiUpdateFormationBody
  implicit lazy val ToJsonUpdateFormation: ToJson[Formation.models.Update] = SprayJsonIgnoreNullBoilerplate.ToJsonUpdateFormation
